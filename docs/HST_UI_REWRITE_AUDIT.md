...
| `Configs/Map/HST_SetupHQMap.conf` | Setup map config | Allowed for setup only | Must not replace gameplay map behavior. Verify separate gameplay map config before completion. |
