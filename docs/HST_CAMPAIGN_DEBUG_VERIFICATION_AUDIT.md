...
## Schema 69 Exact Enemy Counterattack Engine-Proof Boundary

The active development tree uses Campaign Schema 69 while runtime settings
remain on Schema 24. Newly admitted enemy counterattacks use
