...
1. Repack and rerun the dedicated server proof on the r120 population-income
   build, then compare economy source breakdowns, population income scaling, icon deconflicts, Western Heights removal,
