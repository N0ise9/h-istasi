...
| Strategic mission effects | Missions affect money, HR, town support, aggression, HQ knowledge, enemy pools, and unlocks. | Broad Alpha | Mission success/failure, mission expiry, and resistance zone captures now record durable strategic-event rows with before/after deltas; next route convoy outcome branches, vehicle reports, support-near-HQ, and town influence through the same ledger. | High |
...
6. Route convoy outcome branches, vehicle reports, support-near-HQ, and town
   influence through the strategic-event ledger.
