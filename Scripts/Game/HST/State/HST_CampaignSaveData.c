...
class HST_CampaignSaveData
{
	...
	protected HST_StrategicEventState CopyStrategicEvent(HST_StrategicEventState source)
	{
		...
		target.m_sTownInfluenceEventId = source.m_sTownInfluenceEventId;
		target.m_sTownInfluenceKind = source.m_sTownInfluenceKind;
		target.m_iTownFIASupportBefore = source.m_iTownFIASupportBefore;
		target.m_iTownFIASupportAfter = source.m_iTownFIASupportAfter;
		target.m_iTownFIASupportDelta = source.m_iTownFIASupportDelta;
		target.m_iTownOccupierSupportBefore = source.m_iTownOccupierSupportBefore;
		target.m_iTownOccupierSupportAfter = source.m_iTownOccupierSupportAfter;
		target.m_iTownOccupierSupportDelta = source.m_iTownOccupierSupportDelta;
		target.m_iTownReputationBefore = source.m_iTownReputationBefore;
		target.m_iTownReputationAfter = source.m_iTownReputationAfter;
		target.m_iTownReputationDelta = source.m_iTownReputationDelta;
		target.m_iTownHeatBefore = source.m_iTownHeatBefore;
		target.m_iTownHeatAfter = source.m_iTownHeatAfter;
		target.m_iTownHeatDelta = source.m_iTownHeatDelta;
		target.m_iTownPopulationBefore = source.m_iTownPopulationBefore;
		target.m_iTownPopulationAfter = source.m_iTownPopulationAfter;
		target.m_iTownPopulationDelta = source.m_iTownPopulationDelta;
		target.m_iTownKilledBefore = source.m_iTownKilledBefore;
		target.m_iTownKilledAfter = source.m_iTownKilledAfter;
		target.m_iTownKilledDelta = source.m_iTownKilledDelta;
		target.m_iTownPoliceBefore = source.m_iTownPoliceBefore;
		target.m_iTownPoliceAfter = source.m_iTownPoliceAfter;
		target.m_iTownPoliceDelta = source.m_iTownPoliceDelta;
		target.m_iTownRoadblocksBefore = source.m_iTownRoadblocksBefore;
		target.m_iTownRoadblocksAfter = source.m_iTownRoadblocksAfter;
		target.m_iTownRoadblocksDelta = source.m_iTownRoadblocksDelta;
		target.m_bApplied = source.m_bApplied;
		return target;
	}
