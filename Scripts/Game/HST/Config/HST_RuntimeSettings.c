...
class HST_RuntimeSettings
{
	...
	string BuildSummary()
	{
		...
		string features = string.Format("\nfeatures | physical war %1 | area loot %2 | setup read only %3 | GM budgets %4 | player markers %5 | infinite stamina %6", m_Features.m_bPhysicalWarEnabled, m_Features.m_bAreaLootEnabled, m_Features.m_bSetupUiReadOnly, m_Features.m_bGameMasterBudgetsEnabled, m_Features.m_bShowPlayerMapMarkers, m_Features.m_bInfiniteStaminaEnabled);
