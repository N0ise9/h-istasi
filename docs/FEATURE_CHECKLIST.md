...
| Generated routes | Convoys, QRFs, patrols, roadblocks, and mission movement use route-aware paths. | Broad Alpha | Extend route use beyond convoy MVPs into enemy response and garrison behavior. | Highest |
