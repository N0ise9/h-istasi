class HST_PersistenceSmokeTestService
{
	...
	protected void EnsurePrimitiveSmokeMissions(HST_CampaignState state, HST_ZoneState targetZone)
	{
		...
		EnsureSmokePrimitiveMission(state, targetZone, SMOKE_PRIMITIVE_DESTROY_ID, "destroy_outpost_cache", "destroy_target", HST_EMissionObjectiveType.HST_OBJECTIVE_DESTROY_TARGET, "asset", "target", "destroy_target", SMOKE_DESTROY_PREFAB, 1, false);
