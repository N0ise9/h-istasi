...
failure-only audit detail before terminal containment. All five qualifying
Gate 1 evidence slots are pending for this checkpoint.
...
| Certification | Campaign Schema 71 and runtime-settings Schema 24 are current. Frozen source checkpoint `1e18f8c189a66dc92c11a8a81bc3b58725e0fff5` has 436 publish-input rows and digest `06d92f34fe9d8da6c33124357eaecf5f6708d23625f83488fee72e01d15483fb`. It keeps the pre-probe combat-presence refresh, adds the production-style post-`UpdateZoneActivation()` refresh before the strict audit, emits complete failure-only runtime/composition detail, and has Foundation guards for both orderings. All five qualifying evidence slots are pending and no prior rung transfers. Rejected checkpoint `b0b8a6b677092b45f1c7392edcc2d82246d27bbc` passed its first four rungs before Full failed at the generic mission-target pre-admission boundary; its exact failed summary SHA-256 is `66220d35a4d4dfe50af063e50a9eea986f567d2f0d8ae43e5245053cded37788`, and the exact failing subregistry remains unproven. Prior checkpoint `5717d05af0bb1474b8e51a39ad4cef8a4fa341d6` failed at the same generic boundary; its earlier stale-index attribution was an unproven hypothesis. `7fdf3988797edeb747f5d6a6951ad0382bd93db3`, UTC `2026-07-21T19:36:22Z`, label `schema71-settings24-gate1-release-surface`, remains the embedded implementation identity. Former candidate `partisan-rc-5b1f2e98f931-20260721T193941Z`, its package hashes, and the CRI-103 pair remain optional historical local-candidate QA only. Generated `.pak` files are not source deliverables. | Run Foundation, all-target Workbench, the five focused suites, force-authority canary, and Full Campaign Debug in order for the exact frozen checkpoint. Publish only through Workbench to the Workshop after Gate acceptance; the game downloads the addon. Gate 1 is in progress and release remains `NO-GO`; Workshop server/client/network/JIP/reconnect, markers/UI, arbitrary migration, performance, and soak remain open. |
