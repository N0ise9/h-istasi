...
| Certification | Campaign Schema 71 and runtime-settings Schema 24 are current. Rejected source checkpoint `b0b8a6b677092b45f1c7392edcc2d82246d27bbc` has 436 publish-input rows and digest `11999e99c9ab417068e9b371c4ae684217299a35ecad6f2f311e9fe4b4c846f1`. Foundation, all five Workbench targets, all five source-native focused suites, and the source-native force-authority canary passed. Full Campaign Debug then failed at `render_bubble.mission_target.force_physical`: its strict pre-admission baseline reported retained runtime or composition ownership and entered fatal containment without publishing the detailed case artifact. The exact failing subregistry is therefore unproven. The added refresh ran before entering the probe, but the probe itself performs another topology-changing `UpdateZoneActivation()` before the audit. The exact failed summary has SHA-256 `66220d35a4d4dfe50af063e50a9eea986f567d2f0d8ae43e5245053cded37788`, stable source/RDB/settings/executable identities, and zero process or cleanup residue. Prior checkpoint `5717d05af0bb1474b8e51a39ad4cef8a4fa341d6` failed at the same generic boundary; its earlier stale-index attribution was an unproven hypothesis. `7fdf3988797edeb747f5d6a6951ad0382bd93db3`, UTC `2026-07-21T19:36:22Z`, label `schema71-settings24-gate1-release-surface`, remains the embedded implementation identity. Former candidate `partisan-rc-5b1f2e98f931-20260721T193941Z`, its package hashes, and the CRI-103 pair remain optional historical local-candidate QA only. Generated `.pak` files are not source deliverables. | Move the refresh to the actual `UpdateZoneActivation()`-to-audit boundary, emit failure-only audit detail, freeze a new source checkpoint, and rerun Gate 1 from Foundation. Publish only through Workbench to the Workshop after Gate acceptance; the game downloads the addon. Gate 1 is failed and release remains `NO-GO`; Workshop server/client/network/JIP/reconnect, markers/UI, arbitrary migration, performance, and soak remain open. |
