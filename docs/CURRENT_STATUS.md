...
Gate 1 is `in-progress` on frozen source checkpoint `1e18f8c189a66dc92c11a8a81bc3b58725e0fff5`. No rung advances without a tracked, hash-bound source-evidence summary.
...
| Field | Current value |
| --- | --- |
| Status data as of | `2026-07-23T02:05:13Z` |
...
| --- | --- | --- |
| Static/source/resource contracts | `not-run` | Replacement source checkpoint 1e18f8c189a66dc92c11a8a81bc3b58725e0fff5 is frozen with exact 436-input source/worktree identity and zero checkout .pak files. Current Foundation evidence is pending; prior-checkpoint Foundation evidence does not transfer. |
| Enforce compile and configuration | `not-run` | All-target Workbench validation is pending for replacement source checkpoint 1e18f8c189a66dc92c11a8a81bc3b58725e0fff5 after Foundation. Workbench will compile and validate source for the normal Workshop publishing path; no generated archive is a source input. |
| Deterministic service contracts | `not-run` | The five source-native focused suites are pending for replacement checkpoint 1e18f8c189a66dc92c11a8a81bc3b58725e0fff5 after Foundation and Workbench. Prior-checkpoint deterministic-service evidence does not transfer. |
| Native engine-world behavior | `not-run` | The source-native force-authority canary and Full Campaign Debug are pending for replacement checkpoint 1e18f8c189a66dc92c11a8a81bc3b58725e0fff5 after the earlier Gate 1 rungs. Rejected checkpoint b0b8a6b677092b45f1c7392edcc2d82246d27bbc remains immutable history and does not transfer. |
...
| Stable certification | `blocked` | No current matrix row is certified. The complete source-native Gate 1 chain is pending for replacement checkpoint 1e18f8c189a66dc92c11a8a81bc3b58725e0fff5 before later Workshop-installed external gates. |
...
| `STATUS-002` | `TEST` | Replacement source checkpoint 1e18f8c189a66dc92c11a8a81bc3b58725e0fff5 keeps the pre-probe refresh, adds a second combat-presence refresh after the probe's own topology-changing update and before the strict audit, and emits full failure-only audit detail. Restart Gate 1 from Foundation, then all-target Workbench, the five focused suites, force-authority canary, and Full Campaign Debug in order. No generated .pak is part of source or this gate. |
