...
projections. Schema 64 identifies implementation
`6f3c913eaed66926cce38b2ecafcff94084898a3`, UTC
`2026-07-12T11:28:41Z`, and label `schema64-canonical-town-influence`. Foundation passes
...
files/11,695 classes with CRC `36d5b017`, successful validation, and zero HST
...
| --- | --- | --- | --- | --- | --- |
| CRI-0 Truth and baseline | Schema 64 is the current sealed source/Workbench checkpoint; Schema 63 is preceding | Schema 64 identifies implementation `6f3c913eaed66926cce38b2ecafcff94084898a3`, UTC `2026-07-12T11:28:41Z`, and label `schema64-canonical-town-influence`. Schema 63 remains the preceding combat-presence checkpoint; Schema 62 is the canonical-ownership checkpoint and Schema 61 the marker-projection foundation beneath it | Schema-64 Foundation passes at 696 references, including its dedicated gate. Normal and all-five-configuration Workbench checks pass at 5,793 files/11,695 classes with CRC `36d5b017`, successful validation, zero HST script errors, and zero surviving Workbench processes. Campaign Debug and package results remain open | No | Publish only the exact sealed Schema-64 identity. Packaged/native/save-restart/rendered-UI/stutter-horn/setup/network/reconnect/JIP certification remains independently open. |
