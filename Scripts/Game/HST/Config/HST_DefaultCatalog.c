class HST_DefaultCatalog
{
	...
	private static void ApplyEveronLocationPlanOverrides(HST_CampaignState state, HST_CampaignPreset preset)
	{
		...
		UpsertEveronLocationPlanZone(state, "airfield_airbase_saint_philippe", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_AIRFIELD, "4964.727 28.343 11932.66", 150, 24, "Airbase Saint-Philippe", "MBC_Airport", "bases/base_Airport.layer", "air", 320, 23, "BOSTON", "red", "enemy_base", "comp_airfield_airbase_saint_philippe", "spawn_airfield_garrison");
		UpsertEveronLocationPlanZone(state, "seaport_coastal_base_chotain", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_SEAPORT, "7461.818 7.814 6729.315", 100, 18, "Coastal Base Chotain", "MBC_Chotain", "bases/base_Barracks.layer", "sea", 320, 10, "MONROE", "red", "enemy_base", "comp_seaport_coastal_base_chotain", "spawn_seaport_garrison");
		UpsertEveronLocationPlanZone(state, "seaport_coastal_base_lamentin", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_SEAPORT, "1064.29 5.103 6044.175", 100, 18, "Coastal Base Lamentin", "Port_Lamentin", "ports.layer", "sea", 320, 10, "HOUSTON", "red", "enemy_base", "comp_seaport_coastal_base_lamentin", "spawn_seaport_garrison");
		UpsertEveronLocationPlanZone(state, "seaport_coastal_base_morton", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_SEAPORT, "4966.436 5.367 3869.599", 100, 18, "Coastal Base Morton", "Port_Morton", "ports.layer", "sea", 320, 10, "DALLAS", "red", "enemy_base", "comp_seaport_coastal_base_morton", "spawn_seaport_garrison");
		UpsertEveronLocationPlanZone(state, "outpost_levie_base", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_OUTPOST, "7489.05 164.562 4323.926", 50, 16, "Levie Headquarters Base", "MBC_Levie", "bases/base_Levie.layer", "security", 240, 8, "PROVIDENCE", "red", "enemy_base", "comp_outpost_levie_base", "spawn_outpost_garrison");
		UpsertEveronLocationPlanZone(state, "outpost_military_hospital", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_OUTPOST, "3884.425 15.219 8463.663", 50, 16, "Field Hospital", "MBC_Hospital", "bases/base_Hospital.layer", "security", 240, 8, "CHICAGO", "red", "enemy_base", "comp_outpost_military_hospital", "spawn_outpost_garrison");
		UpsertEveronLocationPlanZone(state, "outpost_firing_range", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_OUTPOST, "7729.352 13.656 8154.149", 43, 15, "Training Grounds", "MBC_TrainingGrounds", "bases/base_TrainingGrounds.layer", "security", 240, 7, "SOUTH DAKOTA", "red", "enemy_base", "comp_outpost_firing_range", "spawn_outpost_garrison");
		UpsertEveronLocationPlanZone(state, "resource_logistics_warehouse", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "5347.874 43.617 10542.923", 80, 14, "Logistics Warehouse", "MBC_SaintPhillipe", "bases/base_SaintPhilippe.layer", "supplies", 190, 12, "", "gold", "resource", "comp_resource_logistics_warehouse", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "factory_power_plant", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "5830.083 4.563 9790.85", 90, 14, "Power Plant", "MBC_PowerPlant", "bases/base_PowerPlant.layer", "power", 220, 15, "", "gold", "resource", "comp_resource_power_plant", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "depot_industrial_supply_depot", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_FACTORY, "6460.508 161.993 6485.497", 110, 14, "Cement Plant", "FC_CementPlant", "factories.layer", "industry", 240, 17, "", "gold", "factory", "comp_factory_cement_plant", "spawn_factory_garrison");
		UpsertEveronLocationPlanZone(state, "factory_concrete_plant", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_FACTORY, "5056.617 27.739 10849.919", 110, 14, "Concrete Plant", "FC_ConcretePlant", "factories.layer", "industry", 240, 17, "", "gold", "factory", "comp_factory_concrete_plant", "spawn_factory_garrison");
		UpsertEveronLocationPlanZone(state, "factory_montignac", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_FACTORY, "4541.109 155.99 6852.202", 110, 14, "Montignac Factory", "FC_MontiW", "factories.layer", "industry", 240, 17, "", "gold", "factory", "comp_factory_montignac", "spawn_factory_garrison");
		UpsertEveronLocationPlanZone(state, "factory_saint_philippe", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_FACTORY, "4543.267 16.088 10511.486", 110, 14, "VD Almara Factory", "FC_StPhilippeS", "factories.layer", "industry", 240, 17, "NORTH DAKOTA", "gold", "factory", "comp_factory_saint_philippe", "spawn_factory_garrison");
		UpsertEveronLocationPlanZone(state, "depot_sawmill_supply_depot", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "3080.644 117.548 5212.668", 80, 14, "Le Moule Sawmill", "FC_LeMouleSawmill", "factories.layer", "wood", 180, 12, "", "gold", "resource", "comp_resource_le_moule_sawmill", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "depot_regina_supply_depot", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "7306.477 139.031 2518.856", 80, 14, "Regina Sawmill", "FC_ReginaSawmill", "factories.layer", "wood", 180, 12, "", "gold", "resource", "comp_resource_regina_sawmill", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "resource_quarry", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "8817.028 196.593 3932.52", 75, 14, "Quarry", "FC_Quarry", "factories.layer", "materials", 185, 12, "BROOKLYN", "gold", "resource", "comp_resource_quarry", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "resource_chotain_farm", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "6615.087 109.631 5884.541", 65, 12, "Chotain Farm", "FC_ChotainFarm", "factories.layer", "food", 170, 10, "", "gold", "resource", "comp_resource_chotain_farm", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "resource_montignac_farm", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "5167.388 176.272 7048.875", 65, 12, "Montignac Farm", "FC_MontiFarm", "factories.layer", "food", 170, 10, "", "gold", "resource", "comp_resource_montignac_farm", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "depot_farm_supply_depot", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "4992.117 25.592 9940.01", 65, 12, "Etoupe Farm", "FC_EtoupeFarm", "factories.layer", "food", 170, 10, "", "gold", "resource", "comp_resource_etoupe_farm", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "resource_saint_pierre_fuel_station", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "9705.849 22.502 1720.1", 55, 10, "Saint-Pierre Fuel Station", "fuel_01", "fuelstations.layer", "fuel", 150, 8, "", "gold", "resource", "comp_resource_saint_pierre_fuel_station", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "resource_provins_montignac_fuel_station", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "5342.982 80.641 6313.674", 55, 10, "Provins / Montignac Fuel Station", "fuel_02", "fuelstations.layer", "fuel", 150, 8, "", "gold", "resource", "comp_resource_provins_montignac_fuel_station", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "resource_etoupe_gas_station", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "5308.575 21.303 9835.346", 55, 10, "Etoupe / Power Plant Fuel Station", "fuel_03", "fuelstations.layer", "fuel", 150, 8, "", "gold", "resource", "comp_resource_etoupe_gas_station", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "resource_lamentin_fuel_station", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "1657.306 71.644 5739.421", 55, 10, "Lamentin Fuel Station", "fuel_04", "fuelstations.layer", "fuel", 150, 8, "", "gold", "resource", "comp_resource_lamentin_fuel_station", "spawn_resource_guards");
		UpsertEveronLocationPlanZone(state, "resource_saint_philippe_fuel_station", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RESOURCE, "4609.139 18.657 10662.398", 55, 10, "Saint-Philippe Fuel Station", "fuel_05", "fuelstations.layer", "fuel", 150, 8, "", "gold", "resource", "comp_resource_saint_philippe_fuel_station", "spawn_resource_guards");

		UpsertEveronLocationPlanZone(state, "town_lamentin", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "1287.587 47.45 6013.407", 38, 8, "Lamentin", "TC_Lamentin", "towns/town_Lamentin.layer", "population", 220, 4, "", "black", "town", "comp_town_lamentin", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_le_moule", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "2594.323 97.334 5439.671", 38, 9, "Le Moule", "TC_LeMoule", "towns/town_LeMoule.layer", "population", 220, 4, "LIBERTY", "black", "town", "comp_town_le_moule", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_montignac", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "4770.784 174.088 7036.788", 69, 12, "Montignac", "TC_Montignac", "towns/town_Montignac.layer", "population", 335, 7, "VESPER", "black", "town", "comp_town_montignac", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_saint_philippe", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "4433.775 17.818 10737.896", 45, 9, "Saint-Philippe", "TC_StPhilippe", "towns/town_StPhilippe.layer", "population", 240, 4, "", "black", "town", "comp_town_saint_philippe", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_saint_pierre", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_TOWN, "9759.036 11.81 1539.799", 45, 9, "Saint-Pierre", "TC_StPierre", "towns/town_StPierre.layer", "population", 240, 4, "AUSTIN", "black", "town", "comp_town_saint_pierre", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_morton", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "5082.813 14.852 3954.27", 38, 8, "Morton", "TC_Morton", "towns/town_Morton.layer", "population", 220, 4, "", "black", "town", "comp_town_morton", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_chotain", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "7045.688 118.217 6010.328", 38, 9, "Chotain", "TC_Chotain", "towns/town_Chotain.layer", "population", 220, 4, "APOLLO", "black", "town", "comp_town_chotain", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_levie", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "7482.018 138.035 4725.215", 38, 9, "Levie", "TC_Levie", "towns/town_Levie.layer", "population", 220, 4, "SPIRIT", "black", "town", "comp_town_levie", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_regina", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_TOWN, "7198.936 137.438 2336.226", 56, 11, "Regina", "TC_Regina", "towns/town_Regina.layer", "population", 285, 6, "REACTOR", "black", "town", "comp_town_regina", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_gravette", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "4091.403 36.236 7788.301", 38, 9, "Gravette", "TC_Gravette", "towns/town_Gravette.layer", "population", 220, 4, "NEW JERSEY", "black", "town", "comp_town_gravette", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_meaux", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "4490.289 14.235 9502.132", 56, 11, "Meaux", "TC_Meaux", "towns/town_Meaux.layer", "population", 285, 6, "REDHAWK", "black", "town", "comp_town_meaux", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_provins", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "5546.651 93.654 6003.296", 44, 9, "Provins", "TC_Provins", "towns/town_Provins.layer", "population", 235, 4, "SUNBURST", "black", "town", "comp_town_provins", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_figari", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "5239.172 62.582 5356.463", 44, 9, "Figari", "TC_Figari", "towns/town_Figari.layer", "population", 235, 4, "STARLIGHT", "black", "town", "comp_town_figari", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_durras", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "8820.34 94.708 2755.229", 31, 8, "Durras", "TC_Durras", "towns/town_Durras.layer", "population", 220, 3, "ATLAS", "black", "town", "comp_town_durras", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_entre_deux", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "5754.625 217.905 7068.624", 31, 8, "Entre-Deux", "TC_EntreDeux", "towns/town_EntreDeux.layer", "population", 220, 3, "TITAN", "black", "town", "comp_town_entre_deux", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_laruns", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "7565.37 82.81 5500.853", 38, 9, "Laruns", "TC_Laruns", "towns/town_Laruns.layer", "population", 220, 4, "COMET", "black", "town", "comp_town_laruns", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_tyrone", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "4928.974 37.441 9061.847", 31, 8, "Tyrone", "TC_Tyrone", "towns/town_Tyrone.layer", "population", 220, 3, "AMBER", "black", "town", "comp_town_tyrone", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_vernon", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_TOWN, "9263.577 58.307 2059.466", 56, 11, "Vernon", "TC_Vernon", "towns/town_Vernon.layer", "population", 285, 6, "JUNKYARD", "black", "town", "comp_town_vernon", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_villeneuve", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "2857.967 86.331 6358.688", 38, 9, "Villeneuve", "TC_Villeneuf", "towns/town_Villeneuf.layer", "population", 220, 4, "NEW HAMPSHIRE", "black", "town", "comp_town_villeneuve", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_kermovan", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_TOWN, "6360.83 5.679 9638.167", 44, 9, "Kermovan", "TC_Kermovan", "towns/town_Kermovan.layer", "population", 235, 4, "NEW MEXICO", "black", "town", "comp_town_kermovan", "spawn_town_patrols");
		UpsertEveronLocationPlanZone(state, "town_erquy", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_TOWN, "10911.79 24.79 11731.3", 38, 9, "Erquy", "TC_Erquy", "towns/town_Erquy.layer", "population", 220, 4, "", "black", "town", "comp_town_erquy", "spawn_town_patrols");

		UpsertEveronLocationPlanZone(state, "radio_lamentin_tower", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "1513.3 61.198 5823.788", 25, 8, "Lamentin Radio Tower", "RSC_Lamentin", "POIs/RadioTowers/Lamentin.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_lamentin_tower", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_le_moule_tower", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "1933.808 81.757 5137.221", 25, 8, "Le Moule Radio Tower", "RSC_LeMoule", "POIs/RadioTowers/LeMoule.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_le_moule_tower", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_st_phillipe_relay", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "4920.975 42.607 10415.15", 25, 8, "Saint-Philippe Radio Tower", "RSC_StPhilippe", "POIs/RadioTowers/StPhilippe.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_st_phillipe_relay", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_saint_pierre_tower", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "9948.328 316.222 2265.166", 25, 8, "Saint-Pierre Radio Tower", "RSC_StPierre", "POIs/RadioTowers/StPierre.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_saint_pierre_tower", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_saules_tower", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "3078.509 22.78 1862.44", 25, 8, "Saules Radio Tower", "RSC_Saules", "POIs/RadioTowers/Saules.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_saules_tower", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_argent_tower", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "10941.133 26.198 8682.443", 25, 8, "Argent Radio Tower", "RSC_Argent", "POIs/RadioTowers/Argent.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_argent_tower", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_margarets_mount", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "9406.599 317.376 3891.71", 25, 8, "Margaret's Mount Radio Tower", "RSC_MargaretsMount", "POIs/RadioTowers/MargaretsMount.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_margarets_mount", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_erquy_lighthouse", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "11419.509 63.866 11284.409", 25, 8, "Erquy Island Radio Tower", "RTC_ErquyIsland", "POIs/RadioTowers/ErquyIsland.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_erquy_lighthouse", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_entre_deux_tower", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "5859.855 236.026 7258.213", 25, 8, "Entre-Deux Radio Tower", "RSC_EntreDeux", "POIs/RadioTowers/EntreDeux.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_entre_deux_tower", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_wolf_hill_tower", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "3845.418 162.777 4308.285", 25, 8, "Wolf Hill Radio Tower", "RSC_WolfHill", "POIs/RadioTowers/WolfHill.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_wolf_hill_tower", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_pins_tower", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "1166.602 40.918 11695.426", 25, 8, "Pins Radio Tower", "RSC_Pins", "POIs/RadioTowers/Pins.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_pins_tower", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_regina_tower", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "7070.868 156.803 2080.595", 25, 8, "Regina Radio Tower", "RSC_Regina", "POIs/RadioTowers/Regina.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_regina_tower", "spawn_radio_patrol");
		UpsertEveronLocationPlanZone(state, "radio_regina2_tower", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_RADIO_TOWER, "7685.4 340.531 3065.327", 25, 8, "Regina2 Radio Tower", "RSC_Regina2", "POIs/RadioTowers/Regina.layer", "communications", 180, 4, "", "black", "radio", "comp_radio_regina2_tower", "spawn_radio_patrol");

		UpsertEveronLocationPlanZone(state, "mission_radar_airport", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_MISSION_SITE, "4417.224 17.935 11717.371", 0, 0, "Airport Radar Site", "RDR_Airport", "POIs/RadarSites/Airport.layer", "radar", 120, 2, "", "black", "mission_site", "comp_mission_radar_airport", "spawn_none");
		UpsertEveronLocationPlanZone(state, "outpost_calvary_hill", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_MISSION_SITE, "3497.976 202.983 5817.62", 0, 0, "Calvary Hill Radar Site", "RDR_CalvaryHill", "POIs/RadarSites/CalvaryHill.layer", "radar", 120, 2, "", "black", "mission_site", "comp_mission_radar_calvary_hill", "spawn_none");
		UpsertEveronLocationPlanZone(state, "mission_radar_saules", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_MISSION_SITE, "2855.396 6.706 2363.671", 0, 0, "Saules Radar Site", "RDR_Saules", "POIs/RadarSites/Saules.layer", "radar", 120, 2, "", "black", "mission_site", "comp_mission_radar_saules", "spawn_none");
		UpsertEveronLocationPlanZone(state, "mission_radar_argent", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_MISSION_SITE, "10894.839 18.222 8818.74", 0, 0, "Argent Radar Site", "RDR_Argent", "POIs/RadarSites/Argent.layer", "radar", 120, 2, "", "black", "mission_site", "comp_mission_radar_argent", "spawn_none");
		UpsertEveronLocationPlanZone(state, "mission_radar_erquy_island", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_MISSION_SITE, "10454.677 14.339 12041.855", 0, 0, "Erquy Island Radar Site", "RDR_ErquyIsland", "POIs/RadarSites/ErquyIsland.layer", "radar", 120, 2, "", "black", "mission_site", "comp_mission_radar_erquy_island", "spawn_none");
		UpsertEveronLocationPlanZone(state, "mission_radar_corsairs_cove", preset.m_sInvaderFactionKey, HST_EZoneType.HST_ZONE_MISSION_SITE, "11619.707 14.698 1484.086", 0, 0, "Corsair's Cove Radar Site", "RDR_CorsairsCove", "POIs/RadarSites/CorsairsCove.layer", "radar", 120, 2, "", "black", "mission_site", "comp_mission_radar_corsairs_cove", "spawn_none");
		UpsertEveronLocationPlanZone(state, "mission_radar_pins", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_MISSION_SITE, "1410.476 39.425 11424.309", 0, 0, "Pins Radar Site", "RDR_Pins", "POIs/RadarSites/Pins.layer", "radar", 120, 2, "", "black", "mission_site", "comp_mission_radar_pins", "spawn_none");
		UpsertEveronLocationPlanZone(state, "mission_radar_andres_beacon", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_MISSION_SITE, "6437.238 28.27 8729.806", 0, 0, "Andre's Beacon Radar Site", "RDR_AndresBeacon", "POIs/RadarSites/AndresBeacon.layer", "radar", 120, 2, "", "black", "mission_site", "comp_mission_radar_andres_beacon", "spawn_none");
		UpsertEveronLocationPlanZone(state, "mission_radar_headquarters", preset.m_sOccupierFactionKey, HST_EZoneType.HST_ZONE_MISSION_SITE, "7291.745 144.579 4357.321", 0, 0, "Headquarters Radar Site", "RDR_Headquarters", "POIs/RadarSites/Headquarters.layer", "radar", 120, 2, "", "black", "mission_site", "comp_mission_radar_headquarters", "spawn_none");
	}

	private static void UpsertEveronLocationPlanZone(HST_CampaignState state, string zoneId, string ownerFactionKey, HST_EZoneType zoneType, vector position, int incomeValue, int garrisonSlots, string displayName, string sourceLayoutId, string sourceLayerName, string resourceKind, int captureRadius, int priority, string markerCallsign, string markerTextColor, string markerStyle, string compositionId, string spawnProfileId)
	{
		...
		ConfigureImportedZone(zone, displayName, sourceLayoutId, sourceLayerName, resourceKind, captureRadius, priority, markerCallsign, markerTextColor, markerStyle, compositionId, spawnProfileId);
	}
