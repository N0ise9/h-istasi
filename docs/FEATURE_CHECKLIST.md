...
| Strategic mission effects | Missions affect money, HR, town support, aggression, HQ knowledge, enemy pools, and unlocks. | Broad Alpha | Mission success/failure, mission expiry, convoy outcomes, and resistance zone captures now record durable strategic-event rows with before/after deltas; next route vehicle reports, support-near-HQ, and town influence through the same ledger. | High |
...
6. Route vehicle reports, support-near-HQ, and town influence through the
