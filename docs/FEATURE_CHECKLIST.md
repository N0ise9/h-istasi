...
| Strategic mission effects | Missions affect money, HR, town support, aggression, HQ knowledge, enemy pools, and unlocks. | Broad Alpha | Mission success/failure, mission expiry, convoy outcomes, resistance zone captures, and hostile support resolved near HQ now record durable strategic-event rows with before/after deltas; next route vehicle reports and town influence through the same ledger. | High |
...
6. Route vehicle reports and town influence through the
